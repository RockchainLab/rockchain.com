<?
$title = "ICT Policy Templates";
$custom_meta = '
<meta name="keywords" content="ICT, ICTSP, Information and Communication Security, Cyber Security Policies, Information and Communication Technology Policy" />
<meta name="description" content="Information and Communication Technology Security policy templates to manage your risk and comply with regulatory requirements." />
<meta name="robots" content="index, follow" />';

$custom_og = '
<meta property="og:url" content="https://www.rockchain.com/"/>
<meta property="og:title" content="ICT Policy Templates"/>
<meta property="og:description" content="Information and Communication Technology Security policy templates to manage your risk and comply with regulatory requirements."/>';
?>
<?php include 'header.php'; ?>
<?php $active = 'ict-policies'; ?>
<section class="section-hero hero-small-illustration hero-illustration-1">
	<div class="container section-hero__container">
		<?php include 'menu.php'; ?>
    <h1 class="heading-1"><span class="highlight">Information and Communication Technology</span> Policy templates</span>.</h1>
	</div>
</section>
<section class="section-white">
	<div class="container section-white__container">
      ...
      <p class="paragraph-1">Are you:</p>
          ...
          <li>Managing digital assets or consumer data of any kind?</li>
...
<section class="section-gray">
	<div class="container section-gray__container">
    <h2 class="heading-2">Policy Templates Pack content</h2>
    <br />
		<div class="row-3 paragraphs">
			<div class="box-6 box-s-margin">
        <p class="paragraph-1">Our policies get you quickly on the right road to defining and implementing your Information and Communication Security procedures and policies tailored for the safe handling of consumer data or other digital assets, following established security standards and evolving industry best practices.</p>
        <p class="paragraph-1">They cover:</p>
				<ul class="point-list">
        ...
        <ul class="paragraph-1">
          <li>ICTSP-01 ICT Security Policy</li>
          <li>ICTSP-02 Policy Framework</li>
          <li>ICTSP-03 Information Classification</li>
          <li>ICTSP-04 Physical Security</li>
          <li>ICTSP-05 Acceptable Use Policy</li>
          <li>ICTSP-06 Encryption Policy</li>
          <li>ICTSP-07 Third Party Policy</li>
          <li>ICTSP-08 Secure Desk Policy</li>
          <li>ICTSP-09 Data Retention and Disposal Policy</li>
          <li>ICTSP-10 Access Control Policy</li>
          <li>ICTSP-11 Incident Resolution Policy</li>
          <li>ICTSP-12 People Security Policy</li>
          <li>ICTSP-13 Malware Policy</li>
          <li>ICTSP-14 Patch Policy</li>
          <li>ICTSP-15 Logging Policy</li>
          <li>ICTSP-16 Crypto Assets Policy</li>
        </ul>
        <br />
        <a class="button-cta" style="background-color:gray; color: white" href="i/sample-policy.pdf" target="_blank">See sample here</a><br /><br />
        </p>
			</div>
		</div>
	</div>
