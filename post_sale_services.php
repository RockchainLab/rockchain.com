...
<section class="section-white">
	<div class="container section-white__container">
		...
		<h2 class="heading-2">Token Sales: Post-Sale services</h2>
		<div class="row-3 paragraphs">
			<div class="box-6 box-m-12">
				<p class="paragraph-1">Successfully completing your token sale presents another set of challenges, such as currency conversion to FIAT currency, listing your token on exchanges and creating a healthy market ecosystem.</p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container section-questions__container">
		<div class="question-wrapper">
			...
			<div class="question-wrapper__answer">
				<p>With a network of our trusted OTC partners we can help you convert the proceeds collected during the token sale event and convert them into FIAT currencies quickly and with less price slippage, so that you can fund your operations and roadmap.</p>
			</div>
		</div>
		<div class="question-wrapper">
