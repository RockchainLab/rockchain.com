...
$custom_meta = '
<meta name="keywords" content="Rockchain, Privacy Policy" />
<meta name="description" content="Rockchain policies regarding the collection, use and disclosure of personal data when you use our Services." />
<meta name="robots" content="index, follow" />';

$custom_og = '
<meta property="og:url" content="https://www.rockchain.com/"/>
<meta property="og:title" content="Privacy Policy"/>
<meta property="og:description" content="Rockchain policies regarding the collection, use and disclosure of personal data when you use our Services."/>';
?>
...
<section class="section-hero hero-small-illustration hero-illustration-1">
	<div class="container section-hero__container">
		...
		<h1 class="heading-1"><span class="highlight">Privacy</span> Policy.</h1>
	</div>
</section>
<section class="section-white">
	<div class="container section-white__container">
				<p class="paragraph-1">
          Effective date: January 17, 2019  <br />  <br />
          ...
          We use your data to provide and improve the Services. By using the Services, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms of Use, accessible from <a href="https://rockchain.com/terms-of-use">https://rockchain.com/terms-of-use</a>.
            ...
            The rockchain.com, rockproof.io and tokentransparency.net websites and other websites from time to time and related Services and applications including any applicable application programming interfaces (“APIs”).
            <br /><br />
            ...
            <br /><br />
            <strong>Data Processors (or Services Providers)</strong> <br />
        ...
        <p class="paragraph-1">
          <h2>Use of Data</h2>
          Rockchain Limited uses the collected data for various purposes:
          <br />
          <ul>
        ...
        <p class="paragraph-1">
          ...
          <br /><br />
          Rockchain Limited may process your Personal Data because:
          <br />
          <ul>
        ...
        <p class="paragraph-1">
          ...
          <br /><br />
          Rockchain Limited will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.
          <br /> <br />
        </p>
        <p class="paragraph-1">
          <h2>Disclosure of Data</h2><br />
          <strong>Business Transaction</strong><br />
          If Rockchain Limited is involved in a merger, acquisition or asset sale, your Personal Data may be transferred. We will provide notice before your Personal Data is transferred and becomes subject to a different Privacy Policy.
          <br /><br />
          <strong>Disclosure for Law Enforcement</strong><br />
          Under certain circumstances, Rockchain Limited may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
          <br /><br />
          <strong>Legal Requirements</strong><br />
          Rockchain Limited may disclose your Personal Data in the good faith belief that such action is necessary to:
          <br />
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Rockchain Limited</li>
        ...
        <p class="paragraph-1">
          ...
          If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Rockchain Limited aims to take reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.
          <br /> <br />
          ...
          <br />
          <strong>The right to withdraw consent.</strong> You also have the right to withdraw your consent at any time where Rockchain Limited relied on your consent to process your personal information.
          <br /> <br />
        ...
        <p class="paragraph-1">
          ...
          We may employ third party companies and individuals to facilitate our Services ("Services Providers"), provide the Services on our behalf, perform Services-related Services or assist us in analysing how our Services is used.
          <br /><br />
