...
<section class="section-white">
	<div class="container section-white__container">
		...
		<div class="row-3 paragraphs">
			...
			<div class="box-6">
				<p class="paragraph-1">Utility Tokens represent future access to a company’s product or service. The defining characteristic of utility tokens is that they are designed to prvide functionality and not as an investments - if properly structured, this feature exempts utility tokens from securities regulations.</p>
